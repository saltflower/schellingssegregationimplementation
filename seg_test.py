...
def test_fillGrid():
    t = seg.fillGrid([['', '', '', ''],
                      ...
                      ['', '', '', ''],
                      ['', '', '', '']], 
                      ["e", "e", "e", "e", "e", "e", "e", "e", "r", "r", "r", "r", "b", "b", "b", "b"])
    expected = [["e", "e", "e", "e"], 
                ["e", "e", "e", "e"], 
                ["r", "r", "r", "r"], 
                ["b", "b", "b", "b"]]
...
def test_updateGridCheckSize():
    t = seg.updateGrid([['e', 'r', 'b', 'e'],
                        ['b', 'b', 'b', 'r'],
                        ['r', 'b', 'b', 'b'],
                        ['b', 'e', 'b', 'b']], 
                        [(0, 1), (1, 3), (2, 0)], [(0, 0), (0, 3), (3, 1)])
